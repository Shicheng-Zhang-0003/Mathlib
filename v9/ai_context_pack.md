...
inline double ml_minimax_cos(double x) {
...
inline ml_quat ml_quat_mul(ml_quat a, ml_quat b) {
    return (ml_quat){
...
inline ml_quat ml_quat_normalize(ml_quat q) {
...
inline ml_quat ml_quat_slerp(ml_quat a, ml_quat b, double t) {
